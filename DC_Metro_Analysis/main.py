...
# Database Setup-Connect to the Cloud SQL instance through the app.yaml file.
#Environmental variables are defined in the app.yaml file.
app.config['DB_USER'] = os.environ['DB_USER']
app.config['DB_PASS'] = os.environ['DB_PASS']
...
class Metro_Ridership(db.Model):
